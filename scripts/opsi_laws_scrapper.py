...
# url to source
FILE_URL = "https://podatki.gov.si/dataset/a989ca8a-08be-4b87-a0ad-a7b6991f387d/" \
...
skip = [
    ...
    ("ZAKO7442", 8),  # specific-format (two columns) # todo: support
]
...
def extract_content_columns(df):
    ...
    for i, (idx, row) in enumerate(df.iterrows()):
        ...
        with open(f"files/htmls/{row['idPredpisa']}_{row['npbNum']}.html", "w") as f:
            f.write(row["vsebina"])
