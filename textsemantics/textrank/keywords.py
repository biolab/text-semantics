...
from textsemantics.textrank.pagerank_weighted import pagerank_weighted as _pagerank
from textsemantics.textrank.textcleaner import clean_text_by_word as _clean_text_by_word
from textsemantics.textrank.textcleaner import tokenize_by_word as _tokenize_by_word
from textsemantics.textrank.commons import build_graph as _build_graph
from textsemantics.textrank.commons import remove_unreachable_nodes as _remove_unreachable_nodes
...
def _strip_word(word, deacc):
    ...
    str
        Cleaned word.
    """
    stripped_word_list = list(_tokenize_by_word(word, deacc))
...
def keywords(text, ratio=0.2, words=None, split=False, scores=False, pos_filter=('NN', 'JJ'),
    ...
    split_text = list(_tokenize_by_word(text, deacc=deacc))
